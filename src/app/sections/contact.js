      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
        <div className="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            ...
            <a href="https://goo.gl/maps/XvPMHxtpsXosBZpD8" className='h-full w-full'>
              <div className="relative overflow-hidden rounded-3xl bg-gray-900 py-6 pb-9 pt-64 shadow-2xl sm:px-12 lg:max-w-lg lg:px-8 lg:pb-8 xl:px-10 xl:pb-10">
                <Image
                  className="absolute inset-0 h-full w-full object-cover"
                  src="/google-location.svg"
                  width={300}
                  height={300}
                  alt=""
                />
